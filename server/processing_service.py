...
class ProcessingService:
    ...
    async def process_meteo_data(self, raw_meteo_data: RawMeteoData):
        ...
        await self._store.store("wellness", raw_meteo_data.timestamp.ToNanoseconds(), wellness_data)
    ...
    async def process_pollution_data(self, raw_pollution_data: RawPollutionData):
        ...
        await self._store.store("pollution", raw_pollution_data.timestamp.ToNanoseconds(), pollution_data)
